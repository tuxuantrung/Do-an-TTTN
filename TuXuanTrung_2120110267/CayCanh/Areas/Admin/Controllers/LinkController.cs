...
namespace CayCanh.Areas.Admin.Controllers
{
    public class LinkController : BaseController
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Slug,ParentId,Orders,MetaKey,MetaDesc,CreateBy,CreateAt,UpdateAt,UpdateBy,Status")] Link link)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Slug,ParentId,Orders,MetaKey,MetaDesc,CreateBy,CreateAt,UpdateAt,UpdateBy,Status")] Link link)
        {
            if (ModelState.IsValid)
            {
